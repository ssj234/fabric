...
export set CORE_PEER_MSPCONFIGPATH=/home/ssj234/fabricwksp/04-ca-2/ssj234/msp
# 调用chaincode 代码

peer chaincode invoke -o orderer.cmbc.com:7050 -C cmbcchannel666 -n statechaincode -v 1.3 -c '{"Args":["invoke","a","b","10"]}'
